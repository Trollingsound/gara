  ...
  return (
    <>
        ...
        <div className="transition-all w-[70%] sm:w-[700px] min-h-screen absolute z-10 bg-[#64748b80]">
          ...
          <div className="transition-all w-full flex justify-between">
            ...
            <div className="transition-all flex justify-center items-center w-14 h-14 p-4 bg-slate-900">
              <svg onClick={() => setSlider(false)} className="lucide lucide-align-left cursor-pointer text-[#fff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" ><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg>
            </div>
      ...
      <div className="py-5 px-9 w-full bg-transparent  min-h-[50px] flex fle-row justify-between items-center">
        ...
        <span>
          <svg onClick={() => setSlider(true)} className="lucide lucide-align-left cursor-pointer text-[#fff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" ><line x1="21" x2="3" y1="6" y2="6" /><line x1="15" x2="3" y1="12" y2="12" /><line x1="17" x2="3" y1="18" y2="18" /></svg>
        </span>

        <span className="sm:flex items-center  hidden">
          <input type="text" className="w-full text-[13px] border-2 border-[#fff] rounded-lg text-[#e2e2de] pr-14 px-5 py-3 bg-[#3d3d3b] right-1" />
          <div className="relative">
            <div className="absolute right-4 top-[-12px]">
              <svg className="lucide lucide-search cursor-pointer text-[#fff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>
            </div>
          </div>
        </span>
        ...
        <span className="sm:hidden block">
          <svg class="lucide lucide-search cursor-pointer text-[#fff]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>
        </span>
      ...
      <main className="transition-all min-h-screen w-full flex flex-col gap-y-4 justify-center sm:py-2 sm:px-10 p-4">
        ...
        <div className="slider w-full bg-[#2e3237] min-h-[140px] sm:min-h-[300px] object-cover overflow-hidden border-2 border-[#fff] rounded-[1rem]">

          <img src="https://animerulz.pro/images/sololevelingSlider.png" alt="" srcset="" className=" object-cover w-full h-auto rounded-[1rem]" />

        </div>

        <span className=" text-[#fff] poppins-bolder-italic">Trending</span>


        <div className="w-full min-h-[200px] flex gap-y-[3.25rem] sm:gap-x-2 flex-wrap justify-evenly overflow-x-scroll rounded-md px-1 py-2 ">
            ...
            tv.map((r) => (
              ...
              <>
                <div className="transition-all imgDiv min-w-[150px] max-h-[209px] flex items-center flex-col overflow-hidden opacity-70 hover:opacity-100">
                  ...
                  <span className=" flex justify-center items-center py-1 font-normal max-w-[150px] w-[150px] text-[#fff] text-[13px] poppins-regular-italic">{r?.title}</span>
                </div>
              </>
        ...
        <span className=" text-[#fff] poppins-bolder-italic">Movies</span>
            ...
            movies.map((r) => (
              ...
              <>
                <div className="transition-all imgDiv min-w-[150px] max-h-[209px] flex items-center flex-col overflow-hidden opacity-70 hover:opacity-100 rounded-md">
                  <img onClick={() => router.push(`/ep?view=${r?.id}&t=${r?.title}`)} className="transition-all hover:scale-90 w-[142px] h-[192px] cursor-pointer rounded-[1rem]" loading="lazy" src={r?.image.length < 25 ? `https://anime-world.in${r?.image}` : `${r?.image}`} alt="" />
                  <span className="py-1 font-normal text-[#fff] text-[13px] poppins-regular-italic">{r?.title}</span>
                </div>
              </>
